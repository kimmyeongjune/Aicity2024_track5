...
data = dict(
    train=[
        dict(
            type = dataset_type,
            classes = CLASSES,
            ann_file=data_root+"onlyperson/cocovid_person_train.json",
            img_prefix=data_root + 'Data/VID/train/',
    ...
    val=dict(
        type = dataset_type,                
        classes = CLASSES,
        ann_file=data_root + 'annotations/cocovid_train.json',
        img_prefix=data_root + 'Data/VID/train/',
    ...
    test=dict(
        type = dataset_type,
        classes = CLASSES,
        ann_file=data_root + 'onlyperson/cocovid_person_test.json',
